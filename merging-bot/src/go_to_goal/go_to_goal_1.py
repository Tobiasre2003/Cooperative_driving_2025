...
class GoToGoalNode:
    ...
    def __init__(self):
        ...
        #@tell ros to run _positions_cb and _speed_cb every time gv_positions and gv_laptop is updated
        ...
        #@Possibly change this to look for next point in path rather than the first but 
        #@ may be better to change i in _position_cb since we have x and y there
    ...
    #@ calculates error by finding the wanted angle end_angle and 
    #@ the current angle of the car to get the error in angle
    def error(self):
