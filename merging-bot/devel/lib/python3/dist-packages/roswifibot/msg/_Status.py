...
"""autogenerated by genpy from roswifibot/Status.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2d4i4di3b().pack(_x.battery_level, _x.current, _x.ADC1, _x.ADC2, _x.ADC3, _x.ADC4, _x.speed_front_left, _x.speed_front_right, _x.odometry_left, _x.odometry_right, _x.version, _x.relay1, _x.relay2, _x.relay3))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.battery_level, _x.current, _x.ADC1, _x.ADC2, _x.ADC3, _x.ADC4, _x.speed_front_left, _x.speed_front_right, _x.odometry_left, _x.odometry_right, _x.version, _x.relay1, _x.relay2, _x.relay3,) = _get_struct_2d4i4di3b().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2d4i4di3b = None
def _get_struct_2d4i4di3b():
    global _struct_2d4i4di3b
    if _struct_2d4i4di3b is None:
        _struct_2d4i4di3b = struct.Struct("<2d4i4di3b")
    return _struct_2d4i4di3b
