...
# advanced model
# Detection = namedtuple('Detection', ['tag_id', 'time_msec', 'x', 'y', 'theta', 'speed', 'camera_id'])
...
if __name__ == '__main__':
    ...
    # advanced mobility tests
    # header_data = struct.pack(HEADER_FORMAT, 1, 2, 0, 123, 0, 0, 2)
    # d1 = struct.pack(DETECTION_FORMAT, 4, 123, 20, 30, 1.2, 0.45, 2)
    # d2 = struct.pack(DETECTION_FORMAT, 5, 123, 20, 30, 1.2, 0.30, 2)
